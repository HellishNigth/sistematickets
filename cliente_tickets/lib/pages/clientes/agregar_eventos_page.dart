    ...
    return Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async{
                   ...
                   var respuesta = await EventosProvider().agregarEvento(nombre, detalle, ubicacion, precio, cantidad, estado, fecha);
                  if(respuesta['messages']!=null){
                    var errores = respuesta['errors'];
                    errNombre = errores['nombreEve'] != null ? errores['nombreEve'][0]:'';
                    errDetalle = errores['detalleEve'] != null ? errores['detalleEve'][0]:'';
                    errUbicacion = errores['ubicacionEve'] != null ? errores['ubicacionEve'][0]:'';
                    errPrecio = errores['precioEve'] != null ? errores['precioEve'][0]:'';
                    errCantidad = errores['cantidadTicket'] != null ? errores['cantidadTicket'][0]:'';
                    errEstado = errores['estado'] != null ? errores['estado'][0]:'';
                    errFecha = errores['fechaEve'] != null ? errores['fechaEve'][0]:'';
                    setState(() {});
                    return;
                  }
